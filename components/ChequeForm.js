...
export const ChequeForm = ({ isOpen, onClose, onSave, chequeType }) => {
    ...
    React.createElement(Modal, { onClose: onClose, title: `Add New ${chequeType === 'payable' ? 'Payable' : 'Receivable'} Cheque` },
      React.createElement('form', { onSubmit: handleSubmit, className: "space-y-4" },
        React.createElement('div', null,
          ...
          React.createElement('input', { type: "text", id: "partyName", name: "partyName", value: formData.partyName, onChange: handleChange, required: true, className: "mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" })
        ),
        React.createElement('div', null,
