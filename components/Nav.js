...
const Nav = ({ activeView, setActiveView }) => {
    ...
    return (
        React.createElement('nav', { className: "sm:bg-white sm:dark:bg-gray-800 sm:shadow-md sm:relative fixed bottom-0 left-0 right-0 z-20 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 sm:border-t-0 pb-[env(safe-area-inset-bottom)]" },
