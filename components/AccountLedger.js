...
const AccountLedger = ({ account, transactions, onAddTransaction, hideAddTransaction = false }) => {
    ...
    return (
        React.createElement(React.Fragment, null,
            React.createElement('div', { className: "bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full border dark:border-gray-700 h-full" },
                React.createElement('div', { className: "flex justify-between items-center p-4 border-b dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10 rounded-t-lg" },
                    ...
                    React.createElement('div', { className: "flex items-center gap-2" },
                        !hideAddTransaction && (
                            React.createElement('button', { onClick: onAddTransaction, className: "px-3 py-1.5 bg-blue-600 text-white font-bold rounded-md hover:bg-blue-700 transition-colors text-xs shadow" },
                                "+ Add Transaction"
                            )
                        ),
                ...
                React.createElement('div', { className: "p-2 md:p-4 max-h-[65vh] overflow-y-auto" },
