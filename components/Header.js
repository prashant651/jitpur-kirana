...
const Header = ({ theme, toggleTheme }) => {
    ...
    return (
        React.createElement('header', { className: "bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-30 pt-safe-top" },
            React.createElement('div', { className: "px-4 py-2 flex justify-between items-center" },
                React.createElement('div', { className: "flex items-center gap-2 overflow-hidden" },
                    React.createElement(Logo, null),
                    React.createElement('div', { className: "flex flex-col" },
                        React.createElement('h1', { className: "text-sm sm:text-lg font-bold text-gray-900 dark:text-white leading-tight truncate" },
                            "Jitpur Kirana"
                        ),
